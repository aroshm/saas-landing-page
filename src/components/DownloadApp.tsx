...
const DownloadApp = () => {
  ...
  [clip-path:polygon(0%_0%,100%_0%,100%_90%,50%_100%,0%_90%)] md:[clip-path:polygon(0%_0%,100%_0%,100%_75%,50%_100%,0%_75%)]

  

  before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-20 md:before:h-30
  before:bg-white before:[clip-path:polygon(0%_0%,100%_0%,100%_50%,50%_100%,0%_50%)]"
      id="download"
    >
